...
subtest
{
    ...
    {
        Nightscape::Parser::Grammar.parse($account, :rule<account>).so;
    }
...
subtest
{
    ...
    {
        Nightscape::Parser::Grammar.parse(
            $plus_or_minus,
            :rule<plus_or_minus>
        ).so;
    }
...
subtest
{
    ...
    {
        Nightscape::Parser::Grammar.parse($amount, :rule<amount>).so;
    }
...
subtest
{
    ...
    {
        Nightscape::Parser::Grammar.parse($posting, :rule<posting>).so;
    }
